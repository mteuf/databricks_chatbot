...
# local flag for immediate feedback display
...
if user_input := st.chat_input("Ask a question..."):
    ...
    # display conversation so far, including the new question
    ...
    # after showing the question, fetch assistant reply with spinner
    with st.spinner("Getting reply..."):
        ...
        # force rerun so reply shows right away
