...
# local flag for immediate thumbs feedback
...
if user_input := st.chat_input("Ask a question..."):
    ...
    # render the conversation so far, including the new question
    ...
    # after showing the user question, get assistant reply
    ...
    # prevent code below from re-displaying a second time
    st.stop()

# replay all messages (for regular rerun, or after assistant replied)
just_submitted_feedback = False  # reset per rerun
